    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.FloatField()),
                ('means_of_payment', models.CharField(choices=[(None, '--please select--'), ('cash', 'Cash'), ('bank', 'Bank Transfer'), ('cheque', 'Cheque'), ('credit_card', 'Credit/Debit Card'), ('others', 'Others')], max_length=20)),
        ...
        migrations.AddField(
            ...
            name='produce',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='farm.Produce'),
        ),
        migrations.AddField(
            model_name='farmproduce',
            name='reported_by',
