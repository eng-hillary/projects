...
menus = [
    ...
    menu.PassTestNode(id='weather', css_class="sidebar-header", label='<span class="fas fa-cloud-sun"></span> <span>Micro Weather Services</span>',
                      test=can_view_weather, pattern_name='weather:communityweather_list', link_attrs={'id': 'weather'}),
