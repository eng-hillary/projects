    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Phone_number1', phonenumber_field.modelfields.PhoneNumberField(max_length=128, null=True, region=None, verbose_name='Phone number 1')),
                ('Phone_number2', phonenumber_field.modelfields.PhoneNumberField(max_length=128, null=True, region=None, verbose_name='Phone number 2')),
                ...
                ('terms_and_conditions', models.TextField(max_length=400)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_mode', models.CharField(blank=True, choices=[(None, '--please select--'), ('cash', 'Cash'), ('bank', 'Bank Transfer'), ('cheque', 'Cheque'), ('mobilemoney', 'Mobile Money'), ('credit_card', 'credit card'), ('others', 'Others')], max_length=25, null=True)),
